...
class NavSection extends Component {
	...
	render(){
		if(this.props.section==='about') {
			return (
				<li className="nav-section" style={{backgroundColor: `${this.props.color}`}}>
					<Link onClick={this.handleClick} to='/about' className={`nav-section__block-link nav--${this.props.section}`}>
						{this.props.title}
					</Link>
					<div className="nav-section__submenu about-submenu" style={{backgroundColor: `${this.props.color}`}}>
						<Link onClick={this.handleClick} to='/about' className="about-submenu__link">About Us</Link>
						<Link onClick={this.handleClick} to='/about/faq' className="about-submenu__link">FAQ</Link>
						<Link onClick={this.handleClick} to='/about/delivery' className="about-submenu__link">Delivery</Link>
						<Link onClick={this.handleClick} to='/about/returns' className="about-submenu__link">Returns</Link>
						<Link onClick={this.handleClick} to='/about/disclaimer' className="about-submenu__link">Disclaimer</Link>
					</div>
				 </li>
			);
		}
		...
		return(
			<li className="nav-section" style={{backgroundColor: `${this.props.color}`}}>
				<Link onClick={this.handleClick} to={link} className={`nav-section__block-link nav--${this.props.section}`}>{this.props.title}</Link>
				<div className="nav-section__submenu" style={{backgroundColor: `${this.props.color}`}}>
					<div className="nav-section__submenu-content">
						...
						<Link onClick={this.handleClick} to={link}>View All {this.props.title}</Link>
					</div>
