	...
	return (
		<main id="checkout">
			...
			<div id="order-summary">
				<h2>Order Summary</h2>
				<p>{total.qty} items</p>
				<ul className="summary-section">{cartItems}</ul>
				<p>
			...
			<div id="checkout-summary">
						...
						<div className="delivery-radio" key={`delivery-option-${i}`}>
							<label>
								<input
									...
									checked={op.price === delivery}
									onChange={handleChange}
								/>{" "}
								{op.title} - ${op.price} - {op.speed} day(s){" "}
				...
				<div id="delivery-options" className="summary-section">
					...
					<div id="check-container">
						...
						<input
							onClick={() => setNoteCheckbox(!noteCheckbox)}
							type="checkbox"
							value="1"
							name="noteCheckbox"
							id="check-1"
						...
						{noteCheckbox && (
							<input
								...
								name="note"
								id="note"
								placeholder="Enter a note for our staff"
