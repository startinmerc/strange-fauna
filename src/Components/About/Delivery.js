		...
		<main id="delivery">
			...
			<div className="boxes">
				<div className="box box__text">
					...
					<p>
						Royal Mail delivery is 94% assured to arrive on your chosen day.
					...
					<p>
						...
						8am-7pm). It’ll really take away any worry when sending gifts for
						special occasions.
					</p>
				</div>
				...
				<div className="box box__text">
					...
					<p>
						We’ve made it really easy to keep tabs on your gift. When your order
						is dispatched, we’ll send you an email that contains a link to track
						your delivery. Simply click the link to find out exactly where it
						is. Or, log into your account, go to My Account and find your
						tracking details there.
					</p>
					<p>
						Can't track your delivery? Don't worry, links may not become active
						until the morning your order is due to arrive.
					</p>
				</div>
			</div>
		</main>
