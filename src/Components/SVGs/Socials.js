...
export const FacebookSquare = ({size=48, color="var(--white)"}) => (
	<svg xmlns="http://www.w3.org/2000/svg" width={size} role="img"
	height={size} viewBox="0 0 24 24" fill={color} className="icon footer__icon">
...
export const TwitterSquare = ({size=48, color="var(--white)"}) => (
	<svg xmlns="http://www.w3.org/2000/svg" width={size} role="img"
	height={size} viewBox="0 0 24 24" fill={color} className="icon footer__icon">
...
export const InstagramSquare = ({size=48, color="var(--white)"}) => (
	<svg xmlns="http://www.w3.org/2000/svg" width={size} role="img"
	height={size} viewBox="0 0 24 24" fill={color} className="icon footer__icon">
...
export const YoutubeSquare = ({size=48, color="var(--white)"}) => (
	<svg xmlns="http://www.w3.org/2000/svg" width={size} role="img"
	height={size} viewBox="0 0 24 24" fill={color} className="icon footer__icon">
